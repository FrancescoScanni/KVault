...
<body class="bg-slate-950 text-white selection:bg-lime-400 selection:text-black antialiased">
    ...
    <section id="features" class="py-24 bg-slate-950 relative border-t border-slate-900">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <a href="pages/security.php"><div class="p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-lime-400/50 transition-colors group">
                ...
                <a href="pages/walletMenu/dashboard.php"><div class="p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-lime-400/50 transition-colors group">
                    <div class="w-14 h-14 bg-slate-950 border border-slate-800 rounded-xl flex items-center justify-center mb-6 group-hover:bg-lime-400/10 transition-colors">
                ...
                <div class="relative overflow-hidden p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-lime-400/50 transition-colors group">
    <div class="w-14 h-14 bg-slate-950 border border-slate-800 rounded-xl flex items-center justify-center mb-6 group-hover:bg-lime-400/10 transition-colors">
    ...
    <div class="absolute inset-0 z-10 flex items-center justify-center bg-slate-950/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <span class="text-lime-400 text-4xl font-black italic tracking-tighter drop-shadow-[0_0_20px_rgba(163,230,53,0.8)]">
            COMING SOON
        </span>
    </div>
</div>
