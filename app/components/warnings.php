...
$errWallet="<div class='fixed top-6 right-6 z-[100] animate-in fade-in slide-in-from-right-4 duration-500'>
                <div class='bg-slate-900/95 backdrop-blur-md border-r-4 border-red-500 p-4 rounded-l-xl shadow-2xl flex items-center gap-4 max-w-sm'>
                    ...
                    <div class='text-right'>
                        <p class='text-white text-xs font-black uppercase tracking-widest leading-none mb-1'>Something went wrong</p>
                        <p class='text-slate-400 text-[10px] font-medium'>You might already have a wallet with the same name.</p>
                    </div>
...
$succTrans="<div class='fixed top-6 right-6 z-[100] animate-in fade-in slide-in-from-right-4 duration-500'>
                <div class='bg-slate-900/95 backdrop-blur-md border-r-4 border-emerald-500 p-4 rounded-l-xl shadow-2xl flex items-center gap-4 max-w-sm'>
                    ...
                    <div class='text-right'>
                        <p class='text-white text-xs font-black uppercase tracking-widest leading-none mb-1'>Transaction Saved</p>
                        <p class='text-slate-400 text-[10px] font-medium'>The ledger has been updated successfully.</p>
                    </div>
...
$errTrans="<div class='fixed top-6 right-6 z-[100] animate-in fade-in slide-in-from-right-4 duration-500'>
                <div class='bg-slate-900/95 backdrop-blur-md border-r-4 border-rose-500 p-4 rounded-l-xl shadow-2xl flex items-center gap-4 max-w-sm'>
                    ...
                    <div class='text-right'>
                        <p class='text-white text-xs font-black uppercase tracking-widest leading-none mb-1'>System Error</p>
                        <p class='text-slate-400 text-[10px] font-medium'>Something went wrong. Please try again or check logs.</p>
                    </div>
